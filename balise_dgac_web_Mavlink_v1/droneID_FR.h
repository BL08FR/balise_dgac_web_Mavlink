...
public:
     ...
     * @param alt
     */
    void set_current_position(int32_t lat, int32_t lon, int16_t alt) // à l'origine alt int16_t
	{
        _latitude = lat * 1e-2;
        _longitude = lon * 1e-2;
        _altitude = alt;
     ...
     * @param alt
     */
    void set_current_position(double lat, double lon, int16_t alt) // à l'origine alt int16_t
	{
        _latitude = lat * 1e5;
        _longitude = lon * 1e5;
        _altitude = alt;
     ...
     * @param alt
     */
    void set_home_position(int32_t lat, int32_t lon, int16_t alt) // à l'origine alt int16_t
	{
     ...
     * @param alt
     */
    void set_home_position(double lat, double lon, int16_t alt) // à l'origine alt int16_t
	{
 ...
 //_2D_distance
  ...
  /**
    ...
    void set_altitude(int16_t alt) // à l'origine int16_t
    {
        _altitude = alt;
    }
    /**
...
private:
    ...
    int32_t _latitude;
    int32_t _longitude;
    int16_t _altitude;// à l'origine int16_t
    int16_t _height;
    int32_t _home_latitude;
    int32_t _home_longitude;
    int16_t _home_altitude;// à l'origine alt int16_t
    ...
    int16_t _last_altitude_sent;// à l'origine alt int16_t
